...
extern int sys_create_kthread(void);
extern int sys_id_kthread(void);
extern int sys_exit_kthread(void);
extern int sys_join_kthread(void);
extern int sys_mutex_alloc_kthread(void);
...
[SYS_id_kthread]  sys_id_kthread,
[SYS_exit_kthread]  sys_exit_kthread,
[SYS_join_kthread]  sys_join_kthread,
